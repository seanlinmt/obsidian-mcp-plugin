...
3. **Check port availability**: Default ports are 3111 (HTTP) and 3443 (HTTPS)
...
1. **Port conflict**: Another application may be using ports 3111/3443. Change ports in plugin settings.
